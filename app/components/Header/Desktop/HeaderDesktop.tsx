...
export default function HeaderDesktop() {
    ...
    return (
        <header id="mainHeader" className="h-20 w-full  shadow-xl">
                ...
                <div>
                    <ul className="flex list-none space-x-4">
                        {navigation.map((i, index) => {
                            return (
                                <li key={index} className={cn("hover:text-secondary-blue", { "text-primary-orange hover:text-primary-orange": index === navigation.length - 1 })}>
